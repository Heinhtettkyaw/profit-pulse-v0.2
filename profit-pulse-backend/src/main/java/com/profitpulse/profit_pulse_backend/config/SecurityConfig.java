    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtFilter jwtFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/inventory/**").permitAll() // Public inventory for cashier view
                        .requestMatchers("/admin/report/**").permitAll() // Public report endpoints
                        // Protect other endpoints by role
